...
export const gallery: GalleryItem[] = [
  ...
  { ...galleryPaths(5), breed: 'Yorkshire teriér Jessie', case: 'strih so sukničkou', h: 300 },
  { ...galleryPaths(6), breed: 'Yorkshire teriér biever', case: 'Letný strih', h: 260 },
  { ...galleryPaths(7), breed: 'Biely špic Denis', case: 'Vyčesávanie, kúpeľ a reneračná kúra na veľmi suchú, poškodenú srsť', h: 240 },
  { ...galleryPaths(8), breed: 'Bišonik Mia', case: 'pravidelné podstrihnutie', h: 280 },
  { ...galleryPaths(9), breed: 'Malá pudlia princezná', case: 'Praktický strih', h: 220 },
  { ...galleryPaths(10), breed: 'Yorkshire teriér Lui', case: 'klasický strih', h: 300 },
  { ...galleryPaths(11), breed: 'Viber', case: 'Veľká výzva 😉', h: 260 },
